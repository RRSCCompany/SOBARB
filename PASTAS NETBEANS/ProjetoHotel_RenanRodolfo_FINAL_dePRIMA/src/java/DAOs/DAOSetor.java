...
public class DAOSetor extends DAOGenerico<Setor> {
    ...
    public List<Setor> listByNome(String nome_Setor) {

        return em.createQuery("SELECT e FROM Setor e WHERE e.nomeSetor) LIKE : nome").setParameter("nome", "%" + nome_Setor + "%").getResultList();
    }
