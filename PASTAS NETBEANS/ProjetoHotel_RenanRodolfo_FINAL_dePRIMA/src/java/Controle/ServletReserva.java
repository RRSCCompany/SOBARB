    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (funcao.equals("excluir")) {
            ...
            try {
                ...
                String msg = "Não foi possível cadastrar a Reserva" + " " + ex.toString();
            ...
            try {
                String str_id = request.getParameter("id");
                int id = Integer.parseInt(str_id);
                Reserva f = daoreserva.obter(id);

                request.setAttribute("reserva", f);
                rd = request.getRequestDispatcher("/alterReserva.jsp");
                rd.forward(request, response);
            } catch (Exception ex) {
                deuErro(request, response, "Reserva não encontrada!");
            }
            ...
            try {
                ...
                deuErro(request, response, "Não foi possivel alterar a Reserva. Erro: " + ex.toString());
            }
        }
