...
public class PeriodoReserva implements Serializable {
    ...
    @JoinColumn(name = "apartamento_id_apartamento", referencedColumnName = "id_apartamento", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    private Acomodacao apartamento;
    ...
    public PeriodoReserva(int dataReserva, int apartamentoIdAcomodacao, int reservaIdReserva) {
        this.periodoReservaPK = new PeriodoReservaPK(dataReserva, apartamentoIdAcomodacao, reservaIdReserva);
    }
    ...
    public void setAcomodacao(Acomodacao apartamento) {
