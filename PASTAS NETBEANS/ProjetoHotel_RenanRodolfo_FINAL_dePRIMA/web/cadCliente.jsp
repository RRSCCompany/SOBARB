...
<form name="formularioPessoa" method="post" action="ServletCliente" class="jumbotron transparente" >
    ...
    <input type="text" class="form-control" id="cidade_de_origem"  name="cidade_de_origem"> 
  </div>
  <div class="form-group container for-about">
    <label>cidade de destino</label>
    <input type="text" class="form-control" id="cidade_de_destino" name="cidade_de_destino">
  </div>
  <div class="form-group container for-about">
    <label>Data de Cadastro</label>
    <input type="Date" class="form-control" id="data_de_cadastro" name="data_de_cadastro" >
  </div>
