...
<%
    Setor f = (Setor) request.getAttribute("setor");
%>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <form name="formularioPessoa" method="post" action="ServletSetor" class="jumbotron transparente" >
            ...
            <div class="form-group container for-about">
                ...
                <input type="text" class="form-control"  name="id" value="<%=f.getIdSetor()%>"> 
            </div>
            <div class="form-group container for-about">
                <label>nome do setor:</label>
                <input type="text" class="form-control"  name="setor_nome" value="<%=f.getNomeSetor()%>"> 
            </div>
