...
public class GUIApartamento extends JDialog {

    private Container cp;

    private JLabel lbID = new JLabel("ID");
    private JLabel lbNomeApartamento = new JLabel("Nome do apartamento");
    private JLabel lbIDTipoApartamento = new JLabel("ID do tipo de apartamento");

    private JTextField tfID = new JTextField(50);
    private JTextField tfNomeApartamento = new JTextField(50);
    private JTextField tfIDTipo = new JTextField(50);
    ...
    private DAOApartamento controle = new DAOApartamento();
    private Acomodacao entidade = new Acomodacao();
    TipoAcomodacao tipoacomodacao = new TipoAcomodacao();


    String[] colunas = {"ID", "NomeAcomodação","IDTipoAcomodação"};
    ...
    public GUIApartamento(JFrame pai) {
        ...
        painelCentro.add(lbNomeApartamento);
        painelCentro.add(tfNomeApartamento);
        painelCentro.add(lbIDTipoApartamento);
        painelCentro.add(tfIDTipo);
        ...
        tfNomeApartamento.setEditable(false);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (tfID.getText().trim().isEmpty()) {
                    ...
                    if (entidade == null) {//nao encontrou
                        ...
                        btAlterar.setVisible(false);
                        btExcluir.setVisible(false);
                        tfNomeApartamento.setText("");
                        tfIDTipo.setText("");
                        texto.setText("Não encontrou na lista - pode Adicionar\n\n\n");//limpa o campo texto

                    } else {//encontrou
                        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                        tfNomeApartamento.setText(entidade.getNomeAcomodacao());
                        tfIDTipo.setText(String.valueOf(entidade.getTipoAcomodacaoIdTipo().getIdTipo() + "-" + entidade.getTipoAcomodacaoIdTipo().getNomeTipo()));
        ...
        btAdicionar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                tfNomeApartamento.requestFocus();
                ...
                tfNomeApartamento.setEditable(true);
        ...
        btSalvar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (acao.equals("alterar")) {
                    Acomodacao entidadeAntigo = entidade;
                    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                    SimpleDateFormat sdfEua = new SimpleDateFormat("yyyy-MM-dd");

                    entidade.setNomeAcomodacao(tfNomeApartamento.getText());
                    entidade.setTipoAcomodacaoIdTipo(daoTipoAcomodacao.obter(Integer.valueOf(tfIDTipo.getText().split("-")[0])));

                    controle.atualizar(entidade);
                    texto.setText("Registro alterado\n\n\n\n\n");//limpa o campo texto
                } else {//adicionar
                    entidade = new Acomodacao();
                    SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                    SimpleDateFormat sdfEua = new SimpleDateFormat("yyyy-MM-dd");

                    entidade.setIdAcomodacao(Integer.valueOf(tfID.getText()));
                    entidade.setNomeAcomodacao(tfNomeApartamento.getText());
                    entidade.setTipoAcomodacaoIdTipo(daoTipoAcomodacao.obter(Integer.valueOf(tfIDTipo.getText().split("-")[0])));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (JOptionPane.YES_OPTION
                        == JOptionPane.showConfirmDialog(null,
                                "Confirma a exclusão do registro <NomeAcomodação = " + entidade.getNomeAcomodacao()+ ">?", "Confirm",
                ...
                btExcluir.setVisible(false);
                btAlterar.setVisible(false);
                texto.setText("Excluiu o registro de " + entidade.getIdAcomodacao()+ " - " + entidade.getNomeAcomodacao()+ "\n\n\n\n\n");//limpa o campo texto
            }
        });
        btListar.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                List<Acomodacao> lt = controle.listInOrderId();
        ...
        tfIDTipo.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                List<String> listaAuxiliar = daoTipoAcomodacao.listInOrderNomeStrings("id");
                if (listaAuxiliar.size() > 0) {
                    String selectedItem = new JanelaPesquisar(listaAuxiliar, 
                         getBounds().x - getWidth() / 2 + getWidth() + 5,
                            tfIDTipo.getBounds().y + tfIDTipo.getHeight()).getValorRetornado();
                    if (!selectedItem.equals("")) {
                        String[] aux = selectedItem.split("-");
                        tfIDTipo.setText(selectedItem);

//                        //preparar para salvar
//                        System.out.println(Integer.valueOf(aux[0]));
                        tipoacomodacao = daoTipoAcomodacao.obter(Integer.valueOf(aux[0]));
                ...
                tfIDTipo.addFocusListener(new FocusListener() { //ao receber o foco, fica verde
            @Override
            public void focusGained(FocusEvent fe) {
                tfIDTipo.setBackground(Color.GREEN);
            }
                            @Override
            public void focusLost(FocusEvent fe) { //ao perder o foco, fica branco
                tfIDTipo.setBackground(corPadrao);
