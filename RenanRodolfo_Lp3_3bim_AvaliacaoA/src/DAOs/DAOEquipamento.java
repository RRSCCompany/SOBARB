...
public class DAOEquipamento extends DAOGenerico<Equipamento> {
    ...
    public List<Equipamento> listByNome(String nomeEquipamento) {
        return em.createQuery("SELECT e FROM Equipamentoe.nomeEquipamentoLIKE : nome").setParameter("nome", "%" + nomeEquipamento + "%").getResultList();
    }
