...
class MenuPrincipal extends JFrame {
    ...
    public MenuPrincipal() {
        ...
        TipoAcomodacao = manipulaimagem.insereBotao(manipulaimagem.criaIcon("../imagenscrud/logotp.jpg", 80, 80), "Tipo da Acomodação");
        pessoa = manipulaimagem.insereBotao(manipulaimagem.criaIcon("../imagenscrud/logopessoa.jpg", 80, 80), "Pessoa");
