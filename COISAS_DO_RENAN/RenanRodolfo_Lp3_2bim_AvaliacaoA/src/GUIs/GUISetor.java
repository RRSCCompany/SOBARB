...
package GUIs;import DAOs.DAOSetor;
...
public class GUISetor extends JDialog {
...
private JLabel lbNomeSetor = new JLabel("NomeSetor");


private JTextField tfID = new JTextField(50);
private JTextField tfNomeSetor = new JTextField(50);
...
private DAOSetor controle = new DAOSetor();
private Setor entidade = new Setor();


String[] colunas = new String[]{ "ID", "NomeSetor"};
...
public GUISetor(JFrame pai) {

        jdialog = new JDialog(pai, "Setor", true);
        jdialog.getContentPane();
        jdialog.pack();
        jdialog.setTitle("Setor");
...
painelCentro.add(lbNomeSetor);
painelCentro.add(tfNomeSetor);
   ...
   public void actionPerformed(ActionEvent e) {
      ...
      if (tfID.getText().trim().isEmpty()) {
         ...
         if (entidade == null) {//nao encontrou
            ...
            tfNomeSetor.setText(entidade.getNomeSetor());
...
btSalvar.addActionListener(new ActionListener() {
   ...
   public void actionPerformed(ActionEvent e) {
      if (acao.equals("alterar")) {
         Setor entidadeAntigo = entidade;
         SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
          SimpleDateFormat sdfEua = new SimpleDateFormat("yyyy-MM-dd");

         entidade.setNomeSetor(tfNomeSetor.getText());
         ...
         entidade.setIdSetor(Integer.valueOf(tfID.getText()));
         entidade.setNomeSetor(tfNomeSetor.getText());
   ...
   @Override   public void actionPerformed(ActionEvent e) {
      ...
      if (JOptionPane.YES_OPTION
         == JOptionPane.showConfirmDialog(null,
            "Confirma a exclusão do registro <NomeSetor = " + entidade.getNomeSetor()+ ">?", "Confirm",
      ...
      btExcluir.setVisible(false);
      btAlterar.setVisible(false);
      texto.setText("Excluiu o registro de " + entidade.getIdSetor()+ " - " + entidade.getNomeSetor()+ "\n\n\n\n\n");//limpa o campo texto
   }
});
btListar.addActionListener(new ActionListener() {
   @Override
   public void actionPerformed(ActionEvent e) {
      List<Setor> lt = controle.listInOrderId();


      String[] colunas = {"ID", "NomeSetor"};
