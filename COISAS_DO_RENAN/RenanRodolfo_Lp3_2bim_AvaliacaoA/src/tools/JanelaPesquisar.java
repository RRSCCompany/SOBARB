...
public class JanelaPesquisar extends JDialog {
    ...
    public JanelaPesquisar(List<Equipamento> lista, int x, int y, String[] nomeColuna) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
    ...
    public JanelaPesquisar(List<Equipamento> lista, int x, int y, Dimension dimensao, String titulo) {//esse construtor é importante para receber dados 
        this.lista = lista;
        this.x = x;
        this.y = y;
